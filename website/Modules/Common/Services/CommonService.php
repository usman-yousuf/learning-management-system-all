...
class CommonService
{
    ...
    #region - EMail - START
        ...
        public function sendVerificationEmail($targetEmail, $subject, $template, $templateParams)
        {
         ...
         /**
         * Send Approve Teacher Notification Email
         *
         * @param String $targetEmail
         * @param String $subject
         * @param String $template
         ...
         * @return void
         */
        public function sendApprovedNotificationEmail($targetEmail, $subject, $template, $templateParams)
        {
            // return getInternalSuccessResponse();
         ...
         * @return void
         */
        public function sendTeacherCourseRejectionEmail($targetEmail, $subject, $template,$templateParams)
        {
            // return getInternalSuccessResponse();
