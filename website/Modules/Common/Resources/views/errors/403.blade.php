...
@section('content')
    <div class="container-fluid text-center position-fixed py-5 h-100">
        <div class="h-100 pt-5">
            <strong class="display-1 font_size_250px-s">403</strong>
            <p class="pt-4 font_size_larger-s">You are not Authorized to access this page. please contact your site admin</p>
