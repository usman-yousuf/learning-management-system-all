...
@php
    ...
    $formId = ($showForm)? 'course_slots_form-d' : '';
            ...
            <div class="col-12 pl-0 pr-2 mb-4 border rounded ">
                <div class="row mt-3 text-center">
                    ...
                    <div class="col-lg-3 col-sm-6 col-md-3 col-xl-3 col-6 mt-3 mt-lg-0 mt-md-0 ">
                        ...
                        <div class=" mt-3">
                            <span class="slot_start_time-d" data-slot_start_time="{{ date('H:i:s', strtotime($item->slot_start)) }}">{{ date('h:i A', strtotime($item->slot_start)) }}</span>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-sm-6 col-md-3 col-xl-3 col-6  ">
                        ...
                        <div class="mt-3">
                            <span class="slot_end_date-d">{{ date('d M', strtotime($item->slot_end)) }}</span>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 col-md-3 col-xl-3 col-6 mt-3 mt-lg-0 mt-md-0 ">
                        <div>
                        ...
                        <div class="mt-3">
                            <span class="slot_end_time-d">{{ date('h:i A', strtotime($item->slot_end)) }}</span>
                        </div>
                    </div>
                </div>
