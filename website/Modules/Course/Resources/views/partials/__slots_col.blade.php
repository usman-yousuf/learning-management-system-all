...
@endphp
    ...
    <div class="@if($is_activity_listing) col-lg-6 col-12 @else col-12 @endif pl-0 pr-2 mb-4 border rounded ">
        <div class="row">
            <div class="pt-1 col-1 @if(!$is_activity_listing)d-none @endif">
        ...
        <div class="row mb-3 pt-3 @if(!$is_activity_listing) px-xl-5 mx-xl-5 px-lg-5 @endif">
            <div class=" d-flex @if(!$is_activity_listing)col-xl-3 col-lg-6 col-12 justify-content-md-between justify-content-between @else col-12 justify-content-between pl-4 @endif">
                <div class="slot_day-d @if(strpos($item->day_nums, '6') !== false) custom_day_sign_active-s @else custom_day_sign-s @endif" data-day_num="6"><span>S</span></div>
                <div class="slot_day-d @if(strpos($item->day_nums, '0') !== false) custom_day_sign_active-s @else custom_day_sign-s @endif" data-day_num="0"><span>M</span></div>
                <div class="slot_day-d @if(strpos($item->day_nums, '1') !== false) custom_day_sign_active-s @else custom_day_sign-s @endif" data-day_num="1"><span>T</span></div>
                <div class="slot_day-d @if(strpos($item->day_nums, '2') !== false) custom_day_sign_active-s @else custom_day_sign-s @endif" data-day_num="2"><span>W</span></div>
                <div class="slot_day-d @if(strpos($item->day_nums, '3') !== false) custom_day_sign_active-s @else custom_day_sign-s @endif" data-day_num="3"><span>T</span></div>
                <div class="slot_day-d @if(strpos($item->day_nums, '4') !== false) custom_day_sign_active-s @else custom_day_sign-s @endif" data-day_num="4"><span>F</span></div>
        ...
        <div class="row mb-3 px-xl-5 mx-xl-5  px-lg-5 px-md-2 px-2">
            <div class="d-flex @if(!$is_activity_listing)col-xl-4 col-lg-4 col-md-6 col-12 pt-xl-0 pt-lg-0 pt-md-3 pt-3 @else col-xl-6 col-lg-12 col-md-6 col-12 pt-3 pl-4 @endif">
                ...
                <div class="@if(!$is_activity_listing) col-xl-4 col-lg-4 col-md-6 col-12 text-lg-left text-xl-left text-md-right pt-xl-0 pt-lg-0 pt-md-3 pt-3 @else col-xl-6 col-lg-12 col-md-6 col-12 pt-3 pl-xl-0 pl-lg-4 pl-md-0 pl-4  @endif">
                @if(isset($item) && (null != $item->last_enrolment) )
