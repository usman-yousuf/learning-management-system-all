...
<div class="row flex-column-reverse flex-md-row">
    <div class="{{ $dataColClass }}">
        <div class="row video_course_content_container-d">
            <div class="col-sm-6 col-12 video_course_single_container-d">
                <div class="card shadow mt-4 customs_card-s">
                    <div>
                        ...
                        <img class="video_play_btn-s" src="{{ asset('assets/images/play_icon.svg') }}" data-toggle="modal" data-target="#video_modal-d"  alt="play video icon">
                    </div>
                    <div class="card-body">
                        <h5 class="card-title custom_handout_title-s video_course_title-d">Website Designing</h5>
                        <div class="row pt-2">
