            ...
            <div class="row row-cols-sm-2 row-cols-md-2 row-cols-lg-2 row-cols-xl-5" id="course_details_stats_container-d">
                ...
                <div class="col px-1 mt-4">
                    <div class="body shadow  br_10px-s">
                        <div class="card-body  br_10px-s text-center single_course_stats-s outline_colum-s course_stats-d course_outline_stats-d active" data-target_elm="outline_main_container-d">
                            <div class="d-flex">
                                <h5 class="text-centre mt-2 fs_revert-s">
                ...
                @if($course->nature == 'video')
                    ...
                    <div class="col px-1 mt-4">
                        <div class="body shadow  br_10px-s">
                            <div class="card-body  br_10px-s text-center single_course_stats-s content_colum-s course_stats-d course_video_stats-d" data-target_elm="video_content_main_container-d">
                                <div class="d-flex ">
                                    <h5 class="text-centre mt-2 fs_revert-s ">
                ...
                @else
                    ...
                    <div class="col px-1 mt-4">
                        <div class="body shadow  br_10px-s">
                            <div class="card-body  br_10px-s text-center single_course_stats-s content_colum-s course_stats-d course_slot_stats-d" data-target_elm="course_slot_main_container-d">
                                <div class="d-flex ">
                                    <h5 class="text-centre mt-2 fs_revert-s">
                ...
                <!--card handouts -->
                <div class="col px-1 mt-4">
                    <div class="body shadow w br_10px-s">
                        <div class="card-body  br_10px-s text-center single_course_stats-s handouts_colum-s course_stats-d course_handouts_stats-d" data-target_elm="handout_main_container-d">
                            <div class="d-flex">
                ...
                @if((\Auth::user()->profile_type == 'student') || (\Auth::user()->profile_type == 'parent') )
                    ...
                    <div class="col px-1 mt-4">
                        <div class="body shadow  br_10px-s">
                            <div class="card-body  br_10px-s text-center single_course_stats-s quiz_colum-s course_stats-d course_quiz_stats-d" data-target_elm="course_quiz_main_container-d">
