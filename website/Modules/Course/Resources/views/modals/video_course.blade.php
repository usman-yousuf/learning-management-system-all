<div class="modal fade" id="video_course_details_modal-d">
                ...
                <div class="modal-content">
                                    ...
                                    <div class="col-12">
                                        <nav>
                                            <div class="nav nav-pills" id="nav-tab" role="tablist">
                                                <a class="nav-item nav-link active px-lg-0 px-xl-3 mt-xl-3 " id="nav-home-tab" data-toggle="tab" href="#nav_video_course_detail" role="tab" aria-controls="nav-home" aria-selected="true">Course Details</a>
                                                <a class="nav-item nav-link px-lg-1 p-xl-4 mx-lg-2 mx-xl-3" id="nav-profile-tab" data-toggle="tab" href="#nav_video_course_outline" role="tab" aria-controls="nav-profile" aria-selected="false">Course Outline</a>
                                                <a class="nav-item nav-link px-lg-1 p-xl-4 mx-lg-2 mx-xl-3" id="nav-contact-tab" data-toggle="tab" href="#nav_video_course_slots" role="tab" aria-controls="nav-about" aria-selected="false">Course Slots</a>
                                                <a class="nav-item nav-link px-lg-1 p-xl-4 mx-lg-2 mx-xl-3" id="nav-contact-tab" data-toggle="tab" href="#nav_video_course_content" role="tab" aria-controls="nav-contact" aria-selected="false">Course Content</a>
                                                <a class="nav-item nav-link px-lg-1 p-xl-4 mx-lg-2 mx-xl-3" id="nav-about-tab" data-toggle="tab" href="#nav_video_handout_content" role="tab" aria-controls="nav-about" aria-selected="false">Handout Content</a>
                                                <a class="nav-item nav-link px-lg-1 p-xl-4 mx-lg-2 mx-xl-3" id="nav-about-tab" data-toggle="tab" href="#nav_video_course_fee" role="tab" aria-controls="nav-about" aria-selected="false">Course Fee</a>
                                            </div>
                                        </nav>
                                        <!-- COURSE DETAIL START  -->
                    ...
                    <div class="modal-body">
                        <div class="tab-content  px-3 px-sm-0" id="nav-tabContent">
                            <!-- COURSE DETAIL START -->
                            <div class="tab-pane fade show active" id="nav_video_course_detail" role="tabpanel" aria-labelledby="nav-home-tab">
                                <div class="container w-100">
                                    <form action="" id="video_course_detail_form-d">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7 col-lg-7 col-md-6 col-sm-12 col-12">
                                                ...
                                                <div class="col form-group">
                                                    <label for="course_name" class="font-weight-normal ml-3 course_textarea-s">Course Name</label>
                                                    <input type="text" class="form-control form-control-lg login_input-s w-75" id="course_name" name="course_name" placeholder="Website Designing">
                                                ...
                                                <div class="col form-group pt-3">
                                                    ...
                                                    <select class="form-control  input_radius-s w-75" name="course_category" id="course_category">
                                                ...
                                                <div class="col py-4 text-right">
                                                    <button type="submit" class="btn  course_detail_btn-s video_course_detail_btn-d pt-lg-3 pb-lg-3 " data-target="#nav_course_outline">Next</button>
                                                </div>
                            ...
                            <div class="tab-pane fade" id="nav_video_course_outline" role="tabpanel" aria-labelledby="nav-profile-tab">
                                <div class="w-100">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-5 col-lg-5 col-md-6 col-sm-12 col-12">
                                            <form action="" id="video_course_outline_form-d" class="pt-4 shadow rounded" novalidate>
                            ...
                            <!-- COURSE SLOTS START -->
                            <div class="tab-pane fade" id="nav_video_course_slots" role="tabpanel" aria-labelledby="nav-about-tab">
                                <div class="container-fluid">
                                    <div class="row flex-column-reverse flex-md-row p-3">
                                        ...
                                        <div class="col-lg-4 ml-lg-4 ml-xl-5">
                                            <!-- Form Start -->
                                            <form action="" method="" id="video_course_slots_form-d" class="" novalidate>
                            ...
                            <div class="tab-pane fade" id="nav_video_course_content" role="tabpanel" aria-labelledby="nav-contact-tab">
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-lg-4">
                                        ...
                                        <div class="col-lg-4 ">
                                            <!-- Form Start -->
                                            <form action=" " method="post" id="video_course_content_form-d" class="" novalidate>
                            ...
                            <div class="tab-pane fade" id="nav_video_handout_content" role="tabpanel" aria-labelledby="nav-about-tab">
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="card shadow mt-4 customs_card-s">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="card shadow border-0 mt-4">
                                                <div class="card-body">
                                                    <!-- Form Start -->
                                                    <form action="" method="post" id="video_handout_content_form-d" class="" novalidate>
                                                        <!-- Input Fields Start -->
                                                        <div class="row ">
                                                            <div class="col-12">
                            ...
                            <!-- COURSE FEE START -->
                            <div class="tab-pane fade" id="nav_video_course_fee" role="tabpanel" aria-labelledby="nav-about-tab">
                                <div class="container-fluid ml-lg-4">
                                    ...
                                    <Form action="" id="video_course_fee_form-d" class="" novalidate>
                                        <!-- Input Fields Start -->
