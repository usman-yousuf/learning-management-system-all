...
@section('auth-content')
    ...
    <!-- --------login Form----  -->
    <form id='frm_validate_code-d' class='frm_validate_code-s' action="{{ route('validatePasswordCode') }}" class="needs-validation pt-4" novalidate>
        <div class="col d-inline-flex text-center py-4">
            <div class="col-md-2 p-3 code_border-s code_border-d">
                <input type="number" min='0' max="9" maxlength="1" class='form-control v_code-d v_code-s' placeholder="2" />
            </div>
            <div class="col-md-2 offset-1 p-3 code_border-s code_border-d">
                <input type="number" min='0' max="9" maxlength="1" class='form-control v_code-d v_code-s' placeholder="0" />
            </div>
            <div class="col-md-2 offset-1 p-3 code_border-s code_border-d">
                <input type="number" min='0' max="9" maxlength="1" class='form-control v_code-d v_code-s' placeholder="6" />
            </div>
            <div class="col-md-2 offset-1 p-3 code_border-s code_border-d">
                <input type="number" min='0' max="9" maxlength="1" class='form-control v_code-d v_code-s last-d' placeholder="8" />
            </div>
        </div>
