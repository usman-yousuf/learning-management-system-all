...
class StudentController extends Controller
{
    ...
    /**
     * List all student enroll courses 
     *
     * @param [type] $nature
     * @param Request $request
     * @return void
     */
    public function listStudentEnrollNature($natur, Request $request)
    {
    ...
    /**
     * List all student suggest courses 
     *
     * @param [type] $nature
     * @param Request $request
     * @return void
     */
    public function listStudentSuggestedNature($natur, Request $request)
    {
