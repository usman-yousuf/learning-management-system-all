                    ...
                    <div class="modal-body mb-5">
                        ...
                        <div class="row py-3 px-xl-5 pb-5">
                            <div class="col-xl-3 col-lg-3 col-md-6 col-12 mt-xl-0 mt-lg-0 mt-md-0 mt-3 fg-success-s">
                                <span>
                                    Total Mark: <strong class='students_count-d'>50</strong>
                                </span>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-6 col-12 mt-xl-0 mt-lg-0 mt-md-0 mt-3 fg-success-s">
                                <span>
                                    Obtained Mark:  <strong class='attempts_count-d'>40</strong>
                                </span>
                            </div>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-12 mt-xl-0 mt-lg-0 mt-md-3 mt-3 text-xl-right text-lg-right fg_dark-s">
                                <span >
                                    <img class="img_25_x_25-s" src="../assets/preview/student_quiz_calender.svg" alt="calender">
                                </span>
                                <span class="pl-2">
                                    01 Feb 2021
                                </span>
