                ...
                <div class="container pb-5">
                    ...
                    <form action="{{ route('student.uploadAssignment') }}" id="student_submit_assignment-d" method="post">
                                ...
                                <div class="col-12 d-md-flex">
                                    <div class="text-center">
                                        <div class="file-loading">
                                            ...
                                            <input id="upload_experience_image-d" type="file" onchange="previewUploadedFile(this, '#experience_thumb-d', '#hdn_experience_image-d', 'Upload Assignment');" data-allowed_fileExtensions="{{ getAllowedFileExtensions('Upload Assignment') }}">
                                        </div>
                        ...
                        <div class="modal-footer border-0 mb-4 mt-3  justify-content-center">
                            <input type="hidden" name="" class="get_course_uuid-d" value="">
                            <input type="hidden" name="" class="get_assignment_uuid-d" value="">
