                            ...
                            <div class="container mt-5">
                                ...
                                <div class="row py-4">
                                    <div class="col-12 text-right pr-5">
                                        ...
                                        <button class='btn btn-success btn_success' role="button" @if((isset($course) && ($course->available_slots_count)) && (isset($course) && $course->nature == 'video')) type="submit" @else type="submit" data-dismiss="modal" @endif>@if((isset($course) && ($course->available_slots_count)) || (isset($course) && $course->nature == 'video')) Enroll @else Close @endif</button>
                                    </div>
                                </div>
                            </div>
                        </form>
