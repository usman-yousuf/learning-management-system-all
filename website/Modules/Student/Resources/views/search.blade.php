    ...
    <div class="w-100 px-4">
        <div class="row pt-5 ">
            ...
            <div class="col-xl-7 col-lg-7 col-md-5 col-sm-12 col-12 ">
                <h3 class="country_text-s mt-4 font_family_sans-serif-s">Search Results</h3>
            </div>
                        ...
                        <div id="search_ref_option-d" class="search_dropdown_content-s fg_dark_grey-s border ml-xl-3 ml-lg-2 ml-md-1 ml-2 bg-white text-left" style='display:none;'>
                            ...
                            <div class="">
                                <div class="course_view_more_container-d bg_grey_on_hover-s">
                                    <div class="py-3 pl-4">
                                        <span class="font_family_sans-serif-s">Views All Result with <a class="font-weight-bold fg_black-s see_all_link-d" href="{{ route('student.searchDashboard') }}" data-keywords=''>Keyword</a></span>
                                    </div>
                                </div>
        ...
        <section class="py-3">
            ...
            <div class="row pt-3  pb-3">
                <div class="col-xl-8 col-lg-7 col-md-6 col-sm-12 col-12 mt-2">
                    <h3 class="font_family_sans-serif-s">Searched Courses</h3>
                </div>
