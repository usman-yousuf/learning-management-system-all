...
@section('content')
    <div class="container-fluid px-lg-5 px-md-4 py-4">
        ...
        <div class="row mt-3 mb-3">
            ...
            <div class="col-xl-3 col-lg-5 col-md-6 col-sm-12 col-12 mb-3">
                <div class="card shadow bg_warning-s">
                    <a href="{{ (isset($stats->total_students_count) && ($stats->total_students_count > 0))? route('listEnrolledStudents') : 'javascript:void(0)' }}" class='no_link-s'>
                        <div class="card-body">
                            <div class="d-flex">
            ...
            <div class="col-xl-3 col-lg-5 col-md-6 col-sm-12 col-12 mb-3">
                <div class="card shadow bg_success-s">
                    <a href="{{ (isset($stats->total_free_students_count) && ($stats->total_free_students_count > 0))? route('listFreeStudents') : 'javascript:void(0)' }}" class='no_link-s'>
            ...
            <div class="col-xl-3 col-lg-5 col-md-6 col-sm-12 col-12 mb-3">
                <div class="card shadow bg_info-s">
                    <a href="{{ (isset($stats->total_video_paid_courses_count) && ($stats->total_video_paid_courses_count > 0))? route('listPaidVideoCourses') : 'javascript:void(0)' }}" class='no_link-s'>
                        <div class="card-body mb-1">
                            <div class="d-flex">
                                <div class="bg_black-s rounded">
            ...
            <div class="col-xl-3 col-lg-5 col-md-6 col-sm-12 col-12 mb-3">
                <div class="card shadow bg_pink-s">
                    <a href="{{ (isset($stats->total_online_courses_count) && ($stats->total_online_courses_count > 0))? route('listOnlineCourses') : 'javascript:void(0)' }}" class='no_link-s'>
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="bg_black-s rounded">
        ...
        <div class="row mt-2 mb-3">
            ...
            <div class="col-xl-3 col-lg-5 col-md-6 col-sm-12 col-12 mb-3">
                <div class="card shadow bg_success-s">
                    <a href="{{ (isset($stats->total_teachers_count) && ($stats->total_teachers_count > 0))? route('ourTeachers') : 'javascript:void(0)' }}" class='no_link-s'>
                        <div class="card-body mb-1">
                            <div class="d-flex">
                                <div class="bg_black-s rounded">
                                    <img src="{{ asset('assets/images/reading_book.svg') }}" class="px-2 py-1" alt="">
            ...
            <div class="col-xl-3 col-lg-5 col-md-6 col-sm-12 col-12 mb-3">
                <div class="card shadow bg_pink-s">
                    <a href="{{ (isset($stats->total_completed_courses_count) && ($stats->total_completed_courses_count > 0))? route('listCompletedCourses') : 'javascript:void(0)' }}" class='no_link-s'>
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="bg_black-s rounded">
                                    <img src="{{ asset('assets/images/online_course_icon.svg') }}" class="px-2 py-1" alt="online-course-stats">
            ...
            <div class="col-xl-3 col-lg-5 col-md-6 col-sm-12 col-12 mb-3">
                <div class="card shadow bg_warning-s">
                    <a href="{{ (isset($stats->total_paid_students_count) && ($stats->total_paid_students_count > 0))? route('listPayingStudents') : 'javascript:void(0)' }}" class='no_link-s'>
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="bg_black-s rounded">
                                    <img src="{{ asset('assets/images/enroll_icon.svg') }}" class="px-2 py-2" alt="">
            ...
            <div class="col-xl-3 col-lg-5 col-md-6 col-sm-12 col-12 mb-3">
                <div class="card shadow bg_info-s">
                    <a href="{{ (isset($stats->total_video_courses_count) && ($stats->total_video_courses_count > 0))? route('listVideoCourses') : 'javascript:void(0)' }}" class='no_link-s'>
                        <div class="card-body mb-1">
                            <div class="d-flex">
                                <div class="bg_black-s rounded">
                                    <img src="{{ asset('assets/images/video_course_icon.svg') }}" class="px-2 py-2" alt="">
        ...
        <div class="row mt-2 mb-3">
            ...
            <div class="col-xl-3 col-lg-5 col-md-6 col-sm-12 col-12 mb-3">
                <div class="card shadow bg_pink-s">
                    <a href="{{ (isset($stats->total_online_paid_courses_count) && ($stats->total_online_paid_courses_count > 0))? route('listPaidOnlineCourses') : 'javascript:void(0)' }}" class='no_link-s'>
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="bg_black-s rounded">
                                    <img src="{{ asset('assets/images/online_course_icon.svg') }}" class="px-2 py-1" alt="online-course-stats">
            ...
            <div class="col-xl-3 col-lg-5 col-md-6 col-sm-12 col-12 mb-3">
                <div class="card shadow bg_success-s">
                    <a href="{{ (isset($stats->total_parents_count) && ($stats->total_parents_count > 0))? route('listParents') : 'javascript:void(0)' }}" class='no_link-s'>
                        <div class="card-body mb-1">
                            <div class="d-flex">
                                <div class="bg_black-s rounded">
                                    <img src="{{ asset('assets/images/reading_book.svg') }}" class="px-2 py-1" alt="">
            ...
            <div class="col-xl-3 col-lg-5 col-md-6 col-sm-12 col-12 mb-3">
                <div class="card shadow bg_info-s">
                    <a href="{{ (isset($stats->total_video_free_courses_count) && ($stats->total_video_free_courses_count > 0))? route('listFreeVideoCourses') : 'javascript:void(0)' }}" class='no_link-s'>
                        <div class="card-body mb-1">
                            <div class="d-flex">
                                <div class="bg_black-s rounded">
                                    <img src="{{ asset('assets/images/video_course_icon.svg') }}" class="px-2 py-2" alt="">
            ...
            <div class="col-xl-3 col-lg-5 col-md-6 col-sm-12 col-12 mb-3">
                <div class="card shadow bg_warning-s">
                    <a href="{{ (isset($stats->total_students_count) && ($stats->total_students_count > 0))? route('listStudents') : 'javascript:void(0)' }}" class='no_link-s'>
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="bg_black-s rounded">
                                    <img src="{{ asset('assets/images/enroll_icon.svg') }}" class="px-2 py-2" alt="">
